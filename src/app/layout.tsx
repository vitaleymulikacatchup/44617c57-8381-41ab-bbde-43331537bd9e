...
export const metadata: Metadata = {
  title: "Sakura Sushi Restaurant - Authentic Japanese Cuisine",
  description: "Experience authentic sushi crafted by master chefs using premium ingredients. Elegant dark ambiance, fine dining, and traditional Japanese cuisine since 1998.",
  keywords: ["sushi restaurant", "Japanese cuisine", "authentic sushi", "fine dining", "sashimi", "sushi rolls"],
  metadataBase: new URL("https://sakurasushi.com"),
  alternates: {
    canonical: "https://sakurasushi.com"
  },
  openGraph: {
    title: "Sakura Sushi Restaurant",
    description: "Discover authentic Japanese sushi and fine dining experience",
    type: "website",
    siteName: "Sakura Sushi Restaurant",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34Qgyh3s7JYDSgc82AIVt5yiftd/tmp/premium-sushi-platter-nigiri-sashimi-fre-1764340819495-f43be702.jpg",
        alt: "Premium sushi platter at Sakura"
      }
    ]
  },
  twitter: {
    ...
    title: "Sakura Sushi Restaurant",
    description: "Authentic Japanese sushi and fine dining",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34Qgyh3s7JYDSgc82AIVt5yiftd/tmp/premium-sushi-platter-nigiri-sashimi-fre-1764340819495-f43be702.jpg"]
  }
};
